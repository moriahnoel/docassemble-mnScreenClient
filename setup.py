...
setup(name='docassemble.mnScreenClient',
      ...
      install_requires=[],
      zip_safe=False,
      package_data=find_package_data(where='docassemble/mnScreenClient/', package='docassemble.mnScreenClient'),
     )
